 ...
 * @package  Riki\ProductStockStatus\Model\ResourceModel\StockStatus\Grid
 ...
 */
namespace Riki\ProductStockStatus\Model\ResourceModel\StockStatus\Grid;
 ...
 */
class Collection
    extends \Riki\ProductStockStatus\Model\ResourceModel\StockStatus\Collection
    implements SearchResultInterface
{
    ...
    public function getAllIds($limit = null, $offset = null)
    {
        return $this->getConnection()
            ->fetchCol($this->_getAllIdsSelect($limit, $offset), $this->_bindParams);
    }
