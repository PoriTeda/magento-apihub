...
class Sftp
{
     ...
     */
    protected $sftpReturnsPlugin;

    /**
     * Sftp constructor.
     *
     * @param \Riki\SapIntegration\Plugin\SapIntegration\Cron\Exporter\Returns\Sftp $sftpReturnsPlugin
     * @param \Riki\Framework\Helper\ScopeConfig $scopeConfigHelper
     * @param \Riki\Framework\Helper\Sftp $sftpHelper
     */
    public function __construct(
        \Riki\SapIntegration\Plugin\SapIntegration\Cron\Exporter\Returns\Sftp $sftpReturnsPlugin,
        \Riki\Framework\Helper\ScopeConfig $scopeConfigHelper,
        \Riki\Framework\Helper\Sftp $sftpHelper
    ) {
        $this->sftpReturnsPlugin = $sftpReturnsPlugin;
    ...
    {
        foreach ($this->sftpReturnsPlugin->getFailedIds() as $id) {
