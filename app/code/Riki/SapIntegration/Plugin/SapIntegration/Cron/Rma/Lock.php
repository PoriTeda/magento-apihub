...
class Lock
{
    ...
    /**
     * @var \Riki\SapIntegration\Plugin\SapIntegration\Cron\Rma\EmailNotification
     */
     ...
     * Lock constructor.
     *
     * @param \Riki\SapIntegration\Plugin\SapIntegration\Cron\Rma\EmailNotification $emailNotificationPlugin
     * @param \Magento\Framework\Filesystem $filesystem
     */
    public function __construct(
        \Riki\SapIntegration\Plugin\SapIntegration\Cron\Rma\EmailNotification $emailNotificationPlugin,
    ...
    {
        return 'CronRmaSapExport' . DIRECTORY_SEPARATOR . '.lock';
    }
     ...
     */
    public function afterIsEnabled(\Riki\SapIntegration\Cron\RmaV2 $subject, $result)
    {
        if ($result) {
