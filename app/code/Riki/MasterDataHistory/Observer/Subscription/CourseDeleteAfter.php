...
class CourseDeleteAfter extends MasterDataHistoryObserver implements ObserverInterface
{
    ...
    public function execute(\Magento\Framework\Event\Observer $observer)
    {
        ...
        if ($dirLocal) {
            ...
            $nameCsv = $this->_datetime->date()->getTimestamp() . '-subscription-course.csv';
