...
class SerialCodeImport extends Command
{
    /**
    ...
    protected function configure()
    {
        ...
        $this->setName('riki:serial_code:import')
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        try {
            ...
            if (sizeof($headerError)) {
                $output->writeln("\n------------------------------------------------------------------------------------");
                $output->writeln("Header error please var/log/serial_code_import.log\n");
            ...
            $output->writeln("\n------------------------------------------------------------------------------------");
            $output->writeln($inserted." Import successful\n");
            if ($errorValidate) {
                $output->writeln("\n------------------------------------------------------------------------------------");
