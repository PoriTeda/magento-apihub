...
namespace Riki\SubscriptionMachine\Block\Adminhtml\Customer\Edit\SearchProduct;
...
class GridProduct extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    {
        parent::_construct();
        $this->setId('customer_search_product_grid');
        $this->setRowClickCallback('function (grid, row){
         var trElement = Event.findElement(event, \'tr\');
         var productIdElement = trElement.select(\'td\')[6].innerHTML.trim();
         $(\'machinecustomer_sku\').value = productIdElement;
         $(machinecustomer_searchproduct).hide();
    ...
    {
        return $this->getUrl(
            'machine/customer_edit/LoadBlock',
