...
namespace Riki\SubscriptionMachine\Controller\Adminhtml\Skus\Edit;
...
class LoadBlock extends \Riki\SubscriptionMachine\Controller\Adminhtml\Skus\Edit
{
    /**
     * @var RawFactory
     */
    ...
    public function __construct(
        ...
        parent::__construct($context,$registry,$machineSkusFactory);
    }
    ...
    public function execute()
    {
        ...
        if ($asJson) {
            $resultPage->addHandle('machine_skus_edit_load_block_json');
        } else {
            $resultPage->addHandle('machine_skus_edit_load_block_plain');
        }
        ...
        if ($block) {
            ...
            foreach ($blocks as $block) {
                $resultPage->addHandle('machine_skus_edit_load_block_' . $block);
            }
        }
