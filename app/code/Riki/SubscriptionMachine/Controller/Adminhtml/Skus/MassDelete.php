...
use Riki\SubscriptionMachine\Model\ResourceModel\MachineSkus\CollectionFactory;
...
class MassDelete extends \Riki\SubscriptionMachine\Controller\Adminhtml\Action
{
    ...
    public function execute()
    {
        ...
        if (sizeof($inUsed)) {
            $this->messageManager->addError(__('Machine SKUs has already used in: %1', implode(',', $inUsed)));
        }
        if ($success) {
