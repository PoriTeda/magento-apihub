...
class Visibility extends \Magento\Framework\DataObject implements OptionSourceInterface
{
    ...
    const VISIBILITY_IN_FRONTEND = 2;

    const VISIBILITY_IN_BACKEND = 3;
    ...
    {
        return [self::VISIBILITY_IN_FRONTEND, self::VISIBILITY_BOTH];
    }
    ...
    {
        return [self::VISIBILITY_IN_BACKEND, self::VISIBILITY_BOTH];
    }
    ...
    {
        return [self::VISIBILITY_IN_BACKEND, self::VISIBILITY_IN_FRONTEND, self::VISIBILITY_BOTH];
    }
    ...
    {
        return [
            self::VISIBILITY_NOT_VISIBLE => __('None'),
            self::VISIBILITY_IN_FRONTEND => __('Front-end'),
            self::VISIBILITY_IN_BACKEND => __('Back-end'),
            self::VISIBILITY_BOTH => __('All')
        ];
    }
