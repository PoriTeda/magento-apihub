...
class UnitSap extends \Magento\Framework\DataObject implements OptionSourceInterface
{
    const CS_CASE = 1;
    ...
    {
        return [
            self::CS_CASE => __('CS (Case)'),
            self::EA_EACH => __('EA (Each)')
        ];
    }
    ...
    public function getOptionkey($id)
    {
        $data = [
            self::CS_CASE => 'CS',
            self::EA_EACH => 'EA'
