<?php
namespace Riki\SubscriptionCourse\Block\Adminhtml\Import\Frame;
...
class Result extends \Magento\ImportExport\Block\Adminhtml\Import\Frame\Result
{
    ...
    {
        return '&nbsp;&nbsp;<button onclick="rikiSubCourseCsvUpload.startImport(\'' .
    ...
    {
        return $this->getUrl('subscription/import/start');
    }
}
