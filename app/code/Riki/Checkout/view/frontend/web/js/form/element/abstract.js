...
define([
    ...
    return Element.extend({
        ...
        initConfig: function () {
            ...
            exampleTmp = this.exampleTmp;

            _.extend(this, {
                uid: uid,
                noticeId: 'notice-' + uid,
                inputName: utils.serializeName(name.join('.')),
                exampleTmp: exampleTmp
            });
         ...
         */
        validate: function () {
            var restrictElements = ['city', 'telephone'];
            if(_.contains(restrictElements, this.inputName)) {
        ...
        onUpdate: function () {
            ...
            if( !_.isUndefined(window.checkoutConfig.isNewAddress)  && window.checkoutConfig.isNewAddress ){
                return true; // if is new address
            }
            this.validate();
        }
    });
