...
class PrizeBeforeImport extends Command
{
    ...
    public function __construct(
        ...
        \Riki\Prize\Logger\LoggerImportCsv $loggerInterface,
    ...
    protected function configure()
    {
        ...
        $this->setName('riki:prize:before-import')
            ->setDescription('A cli Import Prize')
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        try {
            ...
            if (sizeof($headerError)) {
                $output->writeln("\n------------------------------------------------------------------------------------");
                $output->writeln("Header error please check var/log/import_prize_csv.log\n");
            ...
            if ($errorValidate) {
                $output->writeln("\n------------------------------------------------------------------------------------");
                $output->writeln("Please check file var/log/import_prize_csv.log\n");
            }else{
                $output->writeln("\n------------------------------------------------------------------------------------");
                $output->writeln("Validate success\n");
            }
        } catch (\Exception $e) {
