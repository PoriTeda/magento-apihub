<?php
namespace Riki\Prize\Block\Adminhtml\Import;
...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct()
    {
        ...
        parent::_construct();
        $this->buttonList->update('back','onclick' ,'setLocation(\'' . $this->getUrl('prize/index/index') . '\')');
    ...
    {
        return $this->getUrl('prize/*/validate', ['_current' => true, 'back' => 'index', 'active_tab' => '{{tab_id}}']);
    }
