...
namespace Riki\User\Controller\Adminhtml\User;
...
class Save extends \Magento\User\Controller\Adminhtml\User\Save
{
    ...
    public function execute()
    {
        ...
        $data['previous_password'] = $helper->appendToPreviousPassword($model->getPreviousPassword(), $passwordChange);
        ...
        $currentUser = $this->_sessionAuth->getUser();
        ...
        try {
            ...
            $passDictionary =  $helper->checkPassDictionary($passwordChange);
            // Check pass exit in Dictionary
            if($passDictionary == true){
                throw new AuthenticationException(__('This password is not acceptable.'));
