...
class ShipmentImporter1501
{
    ...
    /**
     * ShipmentImporter1501 constructor.
     * @param \Riki\ShipmentImporter\Helper\Data $dataHelper
     * @param \Magento\Sales\Model\ResourceModel\Order\CollectionFactory $orderCollectionFactory
     * @param \Magento\Framework\Stdlib\DateTime\DateTime $dateTime
     * @param DirectoryList $directoryList
     * @param Sftp $sftp
     * @param \Riki\ShipmentImporter\Logger\Logger1501 $logger
    ...
    public function __construct(
        ...
        \Riki\ShipmentImporter\Logger\Logger1501 $logger,
    ...
    public function execute()
    {
        ...
        $taskName = __('Completion of Shipped Out (3PLWH) 1501');
        ...
        $this->_dataHelper->backupLog($needDateFile, 'shipment1501.log', '1501');
        ...
        $location = $this->_dataHelper->getLocation1501();
        ...
        $path = $this->_dataHelper->getLocation1501();
        $payCollectedMethod = [
    ...
    public function getSftpFiles($needDateFile)
    {
        ...
        $patternRoot = $this->_dataHelper->getPattern1501();
        $pattern = "/^$patternRoot/";
        ...
        if ($sfptRoot != DIRECTORY_SEPARATOR) {
            $location = $sfptRoot . $this->_dataHelper->getLocation1501();
        } else {
            $location = $this->_dataHelper->getLocation1501();
        }
