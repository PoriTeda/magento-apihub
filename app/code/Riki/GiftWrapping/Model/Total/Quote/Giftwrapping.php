 ...
 */
namespace Riki\GiftWrapping\Model\Total\Quote;

use Magento\Framework\Pricing\PriceCurrencyInterface;
use Magento\Quote\Api\Data\ShippingAssignmentInterface;
use Magento\Quote\Model\Quote\Address;

class Giftwrapping extends \Magento\GiftWrapping\Model\Total\Quote\Giftwrapping
{
    /**
    ...
    protected function _collectWrappingForItems($shippingAssignment, $total)
    {
        ...
        foreach ($items as $item) {
            ...
            $wrappingForItemsBaseTotal += $wrappingBasePrice * (('CS' == $item->getUnitCase())?($item->getQty()/$unitQty):$item->getQty());
            $wrappingForItemsTotal += $wrappingPrice * (('CS' == $item->getUnitCase())?($item->getQty()/$unitQty):$item->getQty());
        }
