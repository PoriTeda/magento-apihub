...
class CategoryMigration
{
     ...
     * @return int
     */
    public function categorySetup($version, $setup = null)
    {
       /*
        * Columns in CSV data
        ...
        */
        ...
        //reset entity increment
        if($setup)
        {
            $tableName = $setup->getTableName('catalog_category_entity');
            $setup->getConnection()->query("ALTER TABLE $tableName AUTO_INCREMENT = 3");
        }
        //import new category
