...
{
    const ADMIN_RESOURCE = 'Riki_Rma::rma_refund_actions_processing_check';
    ...
    public function execute()
    {
        ...
        if ($successCount) {
            $this->messageManager->addSuccess($successCount == 1
                ? __('You processed the refund by Check successfully.')
                : __('You processed %1 refund(s) by Check successfully.', $successCount)
            );
        }
