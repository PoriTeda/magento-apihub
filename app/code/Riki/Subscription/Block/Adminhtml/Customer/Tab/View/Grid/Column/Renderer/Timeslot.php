 ...
 * @codeCoverageIgnore
 */
class Timeslot extends \Magento\Backend\Block\Widget\Grid\Column\Renderer\AbstractRenderer
{
    /**
    ...
    protected function _getValue(\Magento\Framework\DataObject $row)
    {
        ...
        $deliveryType = $this->helperProfile->getTimeSlotOfProfile($profileId);
