 ...
 * @codeCoverageIgnore
 */
class Addressname extends \Magento\Backend\Block\Widget\Grid\Column\Renderer\AbstractRenderer
{
    /**
    ...
    protected function _getValue(\Magento\Framework\DataObject $row)
    {
        ...
        $addressName = $this->helperProfile->getAddressArrOfProfile($profileId,'riki_nickname');

        return implode(',',$addressName);
    }
}
