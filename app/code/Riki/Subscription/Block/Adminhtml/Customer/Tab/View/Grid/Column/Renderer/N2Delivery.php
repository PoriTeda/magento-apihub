 ...
 * @codeCoverageIgnore
 */
class N2Delivery extends \Magento\Backend\Block\Widget\Grid\Column\Renderer\AbstractRenderer
{
    /**
    ...
    protected function _getValue(\Magento\Framework\DataObject $row)
    {
        ...
        $arrNDelivery = $this->helperProfile->getArrThreeDeliveryOfProfile($profileId,'n+2');
        $html = '';
