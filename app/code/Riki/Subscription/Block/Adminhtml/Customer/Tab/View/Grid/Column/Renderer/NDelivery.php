 ...
 * @codeCoverageIgnore
 */
class NDelivery extends \Magento\Backend\Block\Widget\Grid\Column\Renderer\AbstractRenderer
{
    /**
    ...
    protected function _getValue(\Magento\Framework\DataObject $row)
    {
        ...
        $arrNDelivery = $this->helperProfile->getArrThreeDeliveryOfProfile($profileId,'n');
        $html = '';
