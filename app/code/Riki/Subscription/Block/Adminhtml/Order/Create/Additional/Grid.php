 ...
 */
namespace Riki\Subscription\Block\Adminhtml\Order\Create\Additional;
...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    {
        parent::_construct();
        $this->setId('sales_order_create_additional_product_course_grid');
    ...
    protected function _addColumnFilterToCollection($column)
    {
        ...
        if ($column->getId() == 'category_name') {
            ...
            $categoryIdsInCource = $this->subscriptionModel->getAdditionalCategoryIds($courseId);
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            ...
            [
                ...
                'renderer' => 'Riki\Subscription\Block\Adminhtml\Order\Create\Additional\Grid\Column\Renderer\Category',
                'index' => 'category_name'
            ]
        );
        $this->addColumn(
        ...
        $this->addColumn(
            ...
            [
                ...
                'sortable' => false,
                'header' => __('Quantity'),
                'renderer' => 'Riki\Subscription\Block\Adminhtml\Order\Create\Additional\Grid\Column\Renderer\Qty',
                'name' => 'qty',
                'inline_css' => 'qty',
                'type' => 'input',
    ...
    {
        return $this->getUrl('sales/order_create/loadBlock',['block' => 'additional_course_grid', '_current' => true, 'collapse' => null]);
    }
