...
class Confirm extends \Riki\Subscription\Block\Frontend\Profile\ConfirmSpotProduct
{
    ...
    /**
     * Get multiple category data from session manager
     *
     * @return mixed
     */
    public function getMultipleCategoryData()
    {
        return $this->_registry->registry('multiple_category_data');
    }

    /**
     * Get multiple category cache id
     *
     * @return mixed
     */
    public function getMultipleCategoryCacheId()
    {
        return $this->_registry->registry('multiple_category_cache_id');
    }
    ...
    {
        $multipleCategoryData = $this->getMultipleCategoryData();

        if (isset($multipleCategoryData['campaign_id'])) {
            return $multipleCategoryData['campaign_id'];
        }
    ...
    {
        $identifier = $this->getMultipleCategoryCacheId();
