    ...
    AddBySku.prototype = {
        ...
        initialize : function (order, data)
        {
            ...
            function adminOrder()
            {
                ...
                var courseAreaId = this.order.getAreaId('course');
                var machinesAreaId = this.order.getAreaId('machines');
                ...
                jQuery.async('#order-items', (function(){
                    if(typeof this.order.itemsArea !== 'undefined') {
                        this.order.itemsArea.skuButton = new ControlButton($t('Add Products By SKU'));
                        this.order.itemsArea.courseButton = new ControlButton($t('Add Subscription Products'));
                        ...
                        this.order.itemsArea.courseButton.onClick = function () {
                            var el = this;
                        ...
                        this.order.itemsArea.onLoad = this.order.itemsArea.onLoad.wrap(function (proceed) {
                            ...
                            if ($(courseAreaId) && !$(courseAreaId).visible()) {
                                this.addControlButton(this.courseButton);
                            }
                        });
            ...
            {
                var area = ['errors', 'search', 'items', 'shipping_method', 'totals', 'giftmessage','billing_method','delivery_info'];
        ...
        {
            var courseAreaId = this.order.getAreaId('course');
            this.order.itemsArea.addControlButton(this.order.itemsArea.courseButton);
            $(courseAreaId).hide();

        },

        /**
         * open grid machine type
         */
        openGridMachineTypes : function()
        {
            var machineAreaId = this.order.getAreaId('machines');
            $(machineAreaId).show();
        },
        ...
        /*
         Back
         */
        closeGridMachineTypes : function()
        {
            var machineAreaId = this.order.getAreaId('machines');
            $(machineAreaId).hide();
        },
