 ...
 */
namespace Riki\SalesRule\Block\Adminhtml\Import\Frame;
...
class Result extends \Magento\Backend\Block\Template
{
     ...
     * @return $this
     */
    public function addSuccess($message, $appendImportButton = true)
    {
        if (is_array($message)) {
            foreach ($message as $row) {
                $this->addSuccess($row);
    ...
    {
        return $this->getUrl('sales_coupon/promo_quote/import_validate');
    }
