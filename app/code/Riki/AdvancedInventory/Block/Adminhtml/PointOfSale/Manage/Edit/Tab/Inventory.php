...
namespace Riki\AdvancedInventory\Block\Adminhtml\PointOfSale\Manage\Edit\Tab;

class Inventory extends \Magento\Backend\Block\Widget\Form\Generic     implements
    \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        $link = $this->_urlBuilder->getDirectUrl('advancedinventory/rss/feed') .
            '/wh/' . $this->getRequest()->getParam('id');
        $fieldset->addField(
            'rss_feed',
            'link',
            [
        ...
        if ($this->getRequest()->getParam('id')) {
            $fieldset->addField(
                ...
                [
                    ...
                    'note' => __(
                        "Save and apply stock setting to all multi-stock products for this point of sale/warehouse"
                    ),
                ]
            );
