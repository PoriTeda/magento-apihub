...
class SubscriptionType extends Column
{
    ...
    public function prepareDataSource(array $dataSource)
    {
        if (isset($dataSource['data']['items'])) {
            foreach ($dataSource['data']['items'] as & $item) {
                $item['shipment_status'] = $this->prepareItem($item);
            }
        }
    ...
    {
        $orderLegacyObj = $this->_orderLegacyModel->load($item['order_no']);
        return $orderLegacyObj->getShippingStatusLabel();
    }
}