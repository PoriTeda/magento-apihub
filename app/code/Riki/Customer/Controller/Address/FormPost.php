...
class FormPost extends \Magento\Customer\Controller\Address
{
    ...
    public function execute()
    {
        ...
        $returnAppUrl = $this->getRequest()->getParam('return_app_url');
        try {
            ...
            if(!$returnAppUrl) {
                ...
                if($id) {
                    return $this->resultRedirectFactory->create()->setUrl($returnAppUrl);
                } else {
                    return $this->resultRedirectFactory->create()->setUrl($returnAppUrl . 'addressId=' . $savedAddress->getId());
                }
            }
