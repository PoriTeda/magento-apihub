<?php
namespace Riki\Customer\Block\Adminhtml\Shosha\Import;
...
class Import extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct()
    {
        ...
        $this->_controller = 'adminhtml_shosha_import';

        parent::_construct();
        $this->buttonList->update('back','onclick' ,'setLocation(\'' . $this->getUrl('customer/shosha/index') . '\')');
    ...
    {
        return $this->getUrl('customer/shosha/validate', ['_current' => true, 'back' => 'index', 'active_tab' => '{{tab_id}}']);
    }
