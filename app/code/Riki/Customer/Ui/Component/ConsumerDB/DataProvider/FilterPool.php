...
namespace Riki\Customer\Ui\Component\ConsumerDB\DataProvider;
...
class FilterPool
{
     ...
     * @return void
     */
    public function applyFilters(\Riki\Customer\Model\ResourceModel\ConsumerDB\Collection $collection, SearchCriteriaInterface $criteria)
    {
