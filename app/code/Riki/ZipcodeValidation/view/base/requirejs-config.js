var config = {
    paths: {
        'ajaxzip3': 'Riki_ZipcodeValidation/js/lib/ajaxzip3-source'
    },
    'shim': {
        'ajaxzip3': {
                ...
                $.extend(
                    this.AjaxZip3, {
                        ...
                        callback: function(data){
                            ...
                            if(AjaxZip3.amb == 1 || !AjaxZip3.farea){
                                AjaxZip3.updateValue(AjaxZip3.faddr, jaddr);
                            }else{
                                //AjaxZip3.updateValue(AjaxZip3.farea, 'None');
                                AjaxZip3.updateValue(AjaxZip3.faddr, jaddr+jarea);
                            }
