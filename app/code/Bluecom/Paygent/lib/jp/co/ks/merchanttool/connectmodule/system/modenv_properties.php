...
### �N���C�A���g�ؖ����t�@�C���p�X ###
#paygentB2Bmodule.client_file_path=/var/www/riki/public_html/app/code/Bluecom/Paygent/lib/Mdev-20130909_client_cert.pem

#paygentB2Bmodule.client_file_path=Bluecom/Paygent/lib/Mdev-20130909_client_cert.pem
paygentB2Bmodule.client_file_path=Bluecom/Paygent/lib/28905-20150629_client_cert_vr1.pem

### Trusted Server Certificate ###
### �F�؍ς݂�CA�t�@�C���p�X   ###
#paygentB2Bmodule.ca_file_path=/var/www/riki/public_html/app/code/Bluecom/Paygent/lib/curl-ca-bundle.crt

paygentB2Bmodule.ca_file_path=Bluecom/Paygent/lib/curl-ca-bundle.crt
...
### Program Log File     ###
### ���O�t�@�C���o�̓p�X ###
#paygentB2Bmodule.log_output_path=/var/www/riki/public_html/var/log/paygent.log

paygentB2Bmodule.log_output_path=paygent.log
