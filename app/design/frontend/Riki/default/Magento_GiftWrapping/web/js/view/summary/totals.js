...
define(
    ...
    function (Component, quote, totals, GiftWrapping) {
        ...
        return Component.extend({
            ...
            getIncludingTaxValue: function () {
                ...
                if (
                    ...
                    switch (this.level) {
                        ...
                        case 'item':
                            price = (wrappingSegment.hasOwnProperty('gw_items_price_incl_tax') && wrappingSegment.hasOwnProperty('gw_item_ids') && wrappingSegment['gw_item_ids'].length > 0) ?
            ...
            /**
             * Get gift wrapping tax based on options.
             * @returns {int}
             */
            getTaxValue: function () {
                ...
                if (
                    ...
                    switch (this.level) {
                        case 'order':
                            price = wrappingSegment.hasOwnProperty('gw_tax_amount') ?
                                wrappingSegment['gw_tax_amount'] :
                                0;
                            break;

                        case 'item':
                            price = wrappingSegment.hasOwnProperty('gw_items_tax_amount') ?
                                wrappingSegment['gw_items_tax_amount'] :
                                0;
                            break;

                        case 'printed-card':
                            price = wrappingSegment.hasOwnProperty('gw_card_tax_amount') ?
                                wrappingSegment['gw_card_tax_amount'] :
                                0;
                            break;
                    }
                }
