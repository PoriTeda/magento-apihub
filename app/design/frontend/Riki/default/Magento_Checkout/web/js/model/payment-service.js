    ...
    function (_, quote, methodList, selectPaymentMethod) {
        ...
        return {
            ...
            setPaymentMethods: function (methods) {
                ...
                creditCardOnly = window.checkoutConfig.quoteItemData.some(function (item) {
                    return item.product.credit_card_only == '1';
                })

                if(creditCardOnly) {
                    methods = methods.filter(function (item) {
                        return (item.method === 'paygent' || item.method === freeMethodCode);
                    });
                }
