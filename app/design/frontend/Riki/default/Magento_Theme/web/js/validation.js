...
(function (factory) {
    ...
    var rules = {
        ...
        "validate-select-sub-page-frequency": [
            function (value) {
                return ((value !== "none") && (value != "0") && (value != null) && (value.length !== 0));
            },
            $.mage.__('Please select the interval of the subscription.')
        ],
        "validate-select-sub-page-machine": [
            function (value) {
                return ((value !== "none") && (value != null) && (value.length !== 0));
            },
            $.mage.__('Please select a machine.')
        ],
        ...
        "less-than-equals-to-check-point-input": [
            function (value, element, params) {
                if ($.isNumeric($(params).val()) && $.isNumeric(value)) {
                    this.lteToVal = $(params).val();
                    return parseFloat(value) <= parseFloat($(params).val());
            ...
            function () {
                var message = $.mage.__('The specified use point exceeds the "%s"');
                return message.replace('%s', this.lteToVal);
            }
        ],
        ...
        "validate-point-number": [
            ...
            $.mage.__('Please enter the Arabic numeral in the box.')
        ],
        "validate-zero-and-blank": [
            function (v) {
                if( v == 0 || v == ''){
                    return false;
                }
            ...
            $.mage.__("Please enter the Arabic numeral bigger than 1")
        ],
        "validate-emails": [
            function (value) {
