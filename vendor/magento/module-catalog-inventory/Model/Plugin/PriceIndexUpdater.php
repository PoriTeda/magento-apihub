...
class PriceIndexUpdater
{
    ...
    {
        /**
         * NED-3934 - Temporarily remove partial price index when stock change  to resolve performance issue (magento 2.0 does not have this)
         * Further improvement will be done later on
         */
        return $result;
