...
class UpgradeCommand extends AbstractSetupCommand
{
    ...
    protected function configure()
    {
        ...
        \Nestle\Migration\Model\DataMigration::addCommandCustomOption($options);
    ...
    {
        \Magento\Framework\App\ObjectManager::getInstance()->create("Nestle\Migration\Model\DataMigration")->run($input, $output);
        try {
